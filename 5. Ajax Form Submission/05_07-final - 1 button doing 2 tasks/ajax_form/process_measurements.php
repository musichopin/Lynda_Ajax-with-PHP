...
// input boş olsa bile set edilmiş olur
  ...
  if(!empty($errors)) {
    if(is_ajax_request()) {
      ...
      echo json_encode($result_array); // becomes json object with wrapper string
      // alt: double quote is needed for json keys:
      // echo '{ "errors": ' . json_encode($errors) . '}';
    } else { // html form request
